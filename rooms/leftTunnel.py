...
class LeftTunnel(Room):
    ...
    def __init__(self):
        ...
        self.description = "You stand at the end of the tunnel. There is a door in front of you as well as one on your right. The tunnel strecthes far back behind you."
